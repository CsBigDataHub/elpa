;;; verb-autoloads.el --- automatically extracted autoloads
;;
;;; Code:
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "ob-verb" '("ob-verb--" "org-babel-execute:verb")))
...
If called interactively, enable Verb mode if ARG is positive, and
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "verb" '("verb-")))
