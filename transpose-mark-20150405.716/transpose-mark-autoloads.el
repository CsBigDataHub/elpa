;;; transpose-mark-autoloads.el --- automatically extracted autoloads
;;
;;; Code:
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "transpose-mark" '("transpose-mark-")))
